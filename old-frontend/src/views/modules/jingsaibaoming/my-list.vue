<template>
  <div class="page-container tech-theme animate-fade-in-up">
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">My Registration Management</p>
    </div>
    
    <!-- 提示信息 -->
    <div class="role-tip">
      <i class="el-icon-info"></i>
      <span>提示：管理您自己创建的竞赛的报名信息，可以进行审核和操作</span>
    </div>
        ...
        <el-table
          ...
          v-if="isAuth('jingsaibaoming','查看')">
            ...
            <el-table-column width="280" :align="contents.tableAlign"
                ...
                label="操作">
                <template slot-scope="scope">
                  <el-button v-if="isAuth('jingsaibaoming_my','查看')"
    ...
    getDataList() {
      ...
      this.$http({ url: "jingsaibaoming/page", method: "get", params }).then(({ data }) => {
        ...
        if (data && data.code === 0) {
          ...
          console.log('我的报名数据:', this.dataList, '总数:', this.totalPage);
        } else {
