...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      // 修复参赛类型选项，与数据库保持一致
      this.cansaileixingOptions = ['个人赛', '团队赛']
      // 默认设置为个人赛
      if (!this.ruleForm.cansaileixing) {
        this.ruleForm.cansaileixing = '个人赛'
      }
    },
    // 多级联动参数
    info(id) {
